...
<script type="text/javascript">
			...
			function delCategory(cid){
				...
				if(isDel){
					//要删除
					location.href = "${pageContext.request.contextPath}/admin?method=deleteByCid&cid="+cid;
				}
			}
		</script>
</HEAD>
						...
						<c:forEach items="${categoryList }" var="category" varStatus="vs">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="${ pageContext.request.contextPath }/admin?method=updateCategoryUI&cid=${category.cid}">
										<img
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="javascript:void(0);" onclick="delCategory('${category.cid}')">
